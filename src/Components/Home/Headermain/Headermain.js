...
const Headermain = () => {
    return (
        <main className="row align-items-around" style={{paddingTop: '50px'}}>
            <div className="col-md-6 col-12 offset-md-1">
                ...
                <Link to="/login"><button className="btn btn-dark">Hire Us</button></Link>
            </div>
            <div className="row col-md-6 col-12" style={{flex:0}}>
                <img src={Group} style={{height: '350px'}} alt=""/>
            </div>
        </main>
    );
};
